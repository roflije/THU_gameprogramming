class TD_WorldPrototype extends A_World {
    private double timePassed = 0;
    private double timeSinceLastShot = 0;

    private TD_CounterHealth counterH;
    private TD_Counter counterC;
    private TD_HelpTextPrototype helpText;
    ...
    public void init() {
       ...
       System.out.println(squareObjects.size());
        // add the Avatar
        avatar = new TD_Avatar(460, 460);
        ...
        helpText = new TD_HelpTextPrototype(100, 400);
            ...
            if (userInput.keyPressed == '1') {
                {
                    ...
                    for (i = 0; i < sizeOfSquares; ++i)
                    {
                        ...
                        if (sqr != null && !sqr.getTaken()) {
                           ...
                           // gameObjects.add(new TD_AlienPrototype(middle[0], middle[1]));
    ...
    */
    ...
    protected void createZombie(double diffSeconds) {
